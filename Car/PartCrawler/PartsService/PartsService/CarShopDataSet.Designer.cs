...
namespace PartsService.CarShopDataSetTableAdapters {
...
SELECT Car_ID, Car_Model FROM Cars WHERE (Car_ID = @Car_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PartsService.Properties.Settings.Default.MainConn;
        }
...
SELECT Part_ID, part_name, part_price, part_details, part_manuf, Car_ID, Model_ID, CATEGORY_ID FROM Parts WHERE (Part_ID = @Part_ID)";
    ...
    public partial class PARTS_LINKTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PARTS_LINK] ([LINK_ID], [PART_ID], [URL], [LAST_UPDATE], [THRE" +
                "AD]) VALUES (@LINK_ID, @PART_ID, @URL, @LAST_UPDATE, @THREAD);\r\nSELECT LINK_ID, " +
                "PART_ID, URL, LAST_UPDATE, THREAD FROM PARTS_LINK WHERE (LINK_ID = @LINK_ID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PARTS_LINK] SET [LINK_ID] = @LINK_ID, [PART_ID] = @PART_ID, [URL] = @URL, [LAST_UPDATE] = @LAST_UPDATE, [THREAD] = @THREAD WHERE (([LINK_ID] = @Original_LINK_ID) AND ((@IsNull_PART_ID = 1 AND [PART_ID] IS NULL) OR ([PART_ID] = @Original_PART_ID)) AND ((@IsNull_URL = 1 AND [URL] IS NULL) OR ([URL] = @Original_URL)) AND ((@IsNull_LAST_UPDATE = 1 AND [LAST_UPDATE] IS NULL) OR ([LAST_UPDATE] = @Original_LAST_UPDATE)) AND ((@IsNull_THREAD = 1 AND [THREAD] IS NULL) OR ([THREAD] = @Original_THREAD)));
SELECT LINK_ID, PART_ID, URL, LAST_UPDATE, THREAD FROM PARTS_LINK WHERE (LINK_ID = @LINK_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT LINK_ID, PART_ID, URL, LAST_UPDATE, THREAD FROM dbo.PARTS_LINK";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
        ...
        public virtual CarShopDataSet.PARTS_LINKDataTable GetLinks() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CarShopDataSet.PARTS_LINKDataTable dataTable = new CarShopDataSet.PARTS_LINKDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual CarShopDataSet.PARTS_LINKDataTable GetPartsLink() {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            CarShopDataSet.PARTS_LINKDataTable dataTable = new CarShopDataSet.PARTS_LINKDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT P_CATEGORY_ID, CATEGORY_NAME, PROVIDER_NAME, M_CATEGORY_ID FROM PROVIDER_CATEGORIES WHERE (P_CATEGORY_ID = @P_CATEGORY_ID)";
    ...
    public partial class QueriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            ((global::System.Data.SqlClient.SqlCommand)(this._commandCollection[0])).Connection = new global::System.Data.SqlClient.SqlConnection(global::PartsService.Properties.Settings.Default.MainConn);
