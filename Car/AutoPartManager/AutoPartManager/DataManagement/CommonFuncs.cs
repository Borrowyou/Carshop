...
namespace CommonFuncsU
{
    public static class CommonFuncs
    {
        ...
        public static void SetDataSourceReferences(ComboBox[] ControlsArr, DataSet DsetSource)
        {
            foreach (var CurrCtrl in ControlsArr)
                CurrCtrl.DataSource = DsetSource;
        }
    }
}
