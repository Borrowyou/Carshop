...
namespace ServiceManagment.TCommonDataSetTableAdapters {
...
SELECT CLIENT_ID, CLIENT_NAME, CLIENT_FORM, COMPANY, TELEPHONE, EMAIL, DETAILS FROM Clients WHERE (CLIENT_ID = @CLIENT_ID)";
        ...
        public virtual int Fill(TCommonDataSet.ClientsDataTable dataTable) {
        ...
        public virtual TCommonDataSet.ClientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TCommonDataSet.ClientsDataTable dataTable = new TCommonDataSet.ClientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TCommonDataSet.ClientsDataTable dataTable) {
