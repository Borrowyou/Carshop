...
namespace DataManagment
{
    ...
    public partial class CarShopDB : DbContext
    {
        ...
        [DbFunction("CarShopDB", "FUN_YEARS_BETWEEN_LIST")]
        public virtual IQueryable<FUN_YEARS_BETWEEN_LIST_Result> FUN_YEARS_BETWEEN_LIST(Nullable<int> from, Nullable<int> to)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FUN_YEARS_BETWEEN_LIST_Result>("[CarShopDB].[FUN_YEARS_BETWEEN_LIST](@From, @To)", fromParameter, toParameter);
        }
